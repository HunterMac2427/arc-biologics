...
<div class="ab-empty-cart-categories">
  ...
  <div class="ab-categories-grid">
    <a href="<?php echo esc_url($shop_url); ?>#recovery" class="ab-category-card" data-category="recovery">
    ...
    <a href="<?php echo esc_url($shop_url); ?>#cognitive" class="ab-category-card" data-category="cognitive">
      <div class="ab-category-icon">
    ...
    <a href="<?php echo esc_url($shop_url); ?>#antiaging" class="ab-category-card" data-category="antiaging">
      <div class="ab-category-icon">
    ...
    <a href="<?php echo esc_url($shop_url); ?>#bodycomp" class="ab-category-card" data-category="bodycomp">
      <div class="ab-category-icon">
    ...
    <a href="<?php echo esc_url($shop_url); ?>#blends" class="ab-category-card" data-category="blends">
      <div class="ab-category-icon">
    ...
    <a href="<?php echo esc_url($shop_url); ?>#performance" class="ab-category-card" data-category="performance">
      <div class="ab-category-icon">
